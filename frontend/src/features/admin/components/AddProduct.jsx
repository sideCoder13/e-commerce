            ...
            <Stack rowGap={3}>
                ...
                <Stack flexDirection={'row'} >
                    ...
                    <FormControl fullWidth>
                        ...
                        <Select {...register("brand",{required:"Brand is required"})} labelId="brand-selection" label="Brand" value={watch("brand") || ''} >
                    ...
                    <FormControl fullWidth>
                        ...
                        <Select {...register("category",{required:"category is required"})} labelId="category-selection" label="Category" value={watch("category") || ''} >
